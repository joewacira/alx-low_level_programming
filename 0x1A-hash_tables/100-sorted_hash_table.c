...
/**
 * sorted_list - func for insert new node in sorted
...
/**
 * shash_table_set - func adds an element to the sorted hash table
 * @ht: the pointer to sorted hash table
 * @key: the key to add the element
 * @value: the value to add element
 *
...
/**
 * shash_table_get - func retrieves value associeted with key
...
/**
 * shash_table_print - func prints the key:value from ht
 * @ht: the pointer to hash-table
 *
 */
...
/**
 * shash_table_print_rev - func prints key:value
 * from ht in reverse
 * @ht: the pointer to hash-table
 *
 */
...
/**
 * shash_table_delete - func free ht and all nodes
 * @ht: the pointer to hash table
 *
 */
